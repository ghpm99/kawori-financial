    ...
    const headerTableFinancial = [
        {
            ...
            dataIndex: "id",
            key: "id",
            render: (value: any) => <Link href={`/internal/financial/contracts/details/${value}`}>{value}</Link>,
        },
        {
            title: "Nome",
            dataIndex: "name",
        ...
        },
        {
            ...
            dataIndex: "id",
            key: "id",
            render: (value: any) => <Link href={`/internal/financial/contracts/details/${value}`}>Detalhes</Link>,
        },
    ];
